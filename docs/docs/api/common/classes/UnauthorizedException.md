...
Defined in: packages/common/exceptions/unauthorized.exception.ts:11
...
> **new UnauthorizedException**(`objectOrError?`, `descriptionOrOptions?`): `UnauthorizedException`

Defined in: packages/common/exceptions/unauthorized.exception.ts:36
