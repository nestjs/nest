...
Defined in: packages/common/exceptions/not-acceptable.exception.ts:11
...
> **new NotAcceptableException**(`objectOrError?`, `descriptionOrOptions?`): `NotAcceptableException`

Defined in: packages/common/exceptions/not-acceptable.exception.ts:36
