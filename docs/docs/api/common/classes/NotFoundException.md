...
Defined in: packages/common/exceptions/not-found.exception.ts:11
...
> **new NotFoundException**(`objectOrError?`, `descriptionOrOptions?`): `NotFoundException`

Defined in: packages/common/exceptions/not-found.exception.ts:36
