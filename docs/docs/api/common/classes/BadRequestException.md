...
Defined in: packages/common/exceptions/bad-request.exception.ts:11
...
> **new BadRequestException**(`objectOrError?`, `descriptionOrOptions?`): `BadRequestException`

Defined in: packages/common/exceptions/bad-request.exception.ts:36
