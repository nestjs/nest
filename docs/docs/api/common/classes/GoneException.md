...
Defined in: packages/common/exceptions/gone.exception.ts:11
...
> **new GoneException**(`objectOrError?`, `descriptionOrOptions?`): `GoneException`

Defined in: packages/common/exceptions/gone.exception.ts:36
