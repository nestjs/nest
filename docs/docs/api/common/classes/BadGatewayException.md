...
Defined in: packages/common/exceptions/bad-gateway.exception.ts:11
...
> **new BadGatewayException**(`objectOrError?`, `descriptionOrOptions?`): `BadGatewayException`

Defined in: packages/common/exceptions/bad-gateway.exception.ts:36
