...
Defined in: packages/common/exceptions/gateway-timeout.exception.ts:11
...
> **new GatewayTimeoutException**(`objectOrError?`, `descriptionOrOptions?`): `GatewayTimeoutException`

Defined in: packages/common/exceptions/gateway-timeout.exception.ts:36
