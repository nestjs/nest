...
Defined in: packages/common/exceptions/payload-too-large.exception.ts:11
...
> **new PayloadTooLargeException**(`objectOrError?`, `descriptionOrOptions?`): `PayloadTooLargeException`

Defined in: packages/common/exceptions/payload-too-large.exception.ts:36
