...
Defined in: packages/common/exceptions/not-implemented.exception.ts:11
...
> **new NotImplementedException**(`objectOrError?`, `descriptionOrOptions?`): `NotImplementedException`

Defined in: packages/common/exceptions/not-implemented.exception.ts:36
