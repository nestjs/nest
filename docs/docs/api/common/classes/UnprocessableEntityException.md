...
Defined in: packages/common/exceptions/unprocessable-entity.exception.ts:11
...
> **new UnprocessableEntityException**(`objectOrError?`, `descriptionOrOptions?`): `UnprocessableEntityException`

Defined in: packages/common/exceptions/unprocessable-entity.exception.ts:36
