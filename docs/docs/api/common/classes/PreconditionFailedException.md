...
Defined in: packages/common/exceptions/precondition-failed.exception.ts:11
...
> **new PreconditionFailedException**(`objectOrError?`, `descriptionOrOptions?`): `PreconditionFailedException`

Defined in: packages/common/exceptions/precondition-failed.exception.ts:36
