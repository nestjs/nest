...
Defined in: packages/common/exceptions/internal-server-error.exception.ts:11
...
> **new InternalServerErrorException**(`objectOrError?`, `descriptionOrOptions?`): `InternalServerErrorException`

Defined in: packages/common/exceptions/internal-server-error.exception.ts:36
