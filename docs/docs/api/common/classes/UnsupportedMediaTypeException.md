...
Defined in: packages/common/exceptions/unsupported-media-type.exception.ts:11
...
> **new UnsupportedMediaTypeException**(`objectOrError?`, `descriptionOrOptions?`): `UnsupportedMediaTypeException`

Defined in: packages/common/exceptions/unsupported-media-type.exception.ts:36
