...
Defined in: packages/common/exceptions/forbidden.exception.ts:11
...
> **new ForbiddenException**(`objectOrError?`, `descriptionOrOptions?`): `ForbiddenException`

Defined in: packages/common/exceptions/forbidden.exception.ts:36
