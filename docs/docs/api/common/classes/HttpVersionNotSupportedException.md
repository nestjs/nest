...
Defined in: packages/common/exceptions/http-version-not-supported.exception.ts:11
...
> **new HttpVersionNotSupportedException**(`objectOrError?`, `descriptionOrOptions?`): `HttpVersionNotSupportedException`

Defined in: packages/common/exceptions/http-version-not-supported.exception.ts:36
