...
export declare class DependenciesScanner {
    ...
    reflectRelatedModules(module: Type<any>, token: string): void;
    ...
    reflectGuards(component: Type<Injectable>, token: string): void;
    reflectInterceptors(component: Type<Injectable>, token: string): void;
