...
class WsContextCreator {
    ...
    create(instance, callback, module) {
        ...
        return this.wsProxy.create((client, data) => __awaiter(this, void 0, void 0, function* () {
            const canActivate = yield this.guardsConsumer.tryActivate(guards, [client, data], instance, callback);
            if (!canActivate) {
            ...
            return yield this.interceptorsConsumer.intercept(interceptors, [client, data], instance, callback, handler);
        }), exceptionHandler);
    }
