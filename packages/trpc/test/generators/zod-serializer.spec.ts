...
describe('serializeZodSchema', () => {
    ...
    it('should serialize z.literal()', () => {
        ...
        expect(serializeZodSchema(z.literal(true))).to.equal(
            'z.literal(true)',
        );
    });
    ...
    it('should serialize z.union()', () => {
        expect(
            serializeZodSchema(z.union([z.string(), z.number()])),
        ).to.equal('z.union([z.string(), z.number()])');
    });
    ...
    it('should serialize z.tuple()', () => {
        expect(
            serializeZodSchema(z.tuple([z.string(), z.number()])),
        ).to.equal('z.tuple([z.string(), z.number()])');
    });

    it('should serialize z.record()', () => {
        expect(
            serializeZodSchema(z.record(z.string(), z.number())),
        ).to.equal('z.record(z.string(), z.number())');
    });
    ...
    it('should serialize z.set()', () => {
        expect(serializeZodSchema(z.set(z.string()))).to.equal(
            'z.set(z.string())',
        );
    });
