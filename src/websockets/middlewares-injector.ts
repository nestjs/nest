...
} from '@nestjs/core/errors/exceptions/unknown-module.exception';
...
export class MiddlewaresInjector {
  ...
  public applyMiddlewares(server,
  ...
  public bindMiddleware(token: string,
                        components: Map<string, InstanceWrapper<Injectable>>) {
  ...
  public isGatewayMiddleware(middleware: object):
