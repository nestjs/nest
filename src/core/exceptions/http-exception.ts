export class HttpException {
  /**
   * The base Nest Application exception, which is handled by the default
   * Exceptions Handler. If you throw an exception from your HTTP route
   * handlers, Nest will map them to the appropriate HTTP response and send to
   * the client.
   *
