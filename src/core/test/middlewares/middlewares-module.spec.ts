...
describe('MiddlewaresModule', () => {
  ...
  beforeEach(() => {
    (MiddlewaresModule as any).routerExceptionFilter =
  ...
  describe('setupRouteMiddleware', () => {
    ...
    it('should throw "RuntimeException" exception when middlewares is not stored in container',
       () => {
         ...
         expect(
             MiddlewaresModule.setupRouteMiddleware(route as any, configuration,
                                                    'Test' as any, app as any),
             )
    ...
    it('should store middlewares when middleware is stored in container',
       () => {
         ...
         MiddlewaresModule.setupRouteMiddleware(route, configuration, moduleKey,
                                                app as any);
