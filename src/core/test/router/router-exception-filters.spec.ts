...
import {
  UseFilters
} from '../../../common/utils/decorators/exception-filters.decorator';
...
describe('RouterExceptionFilters', () => {
  ...
  describe('create', () => {
    describe('when filters metadata is empty', () => {
      ...
      it('should returns plain ExceptionHandler object', () => {
        const filter =
            exceptionFilter.create(new EmptyMetadata(), () => ({}) as any);
    ...
    describe('when filters metadata is not empty', () => {
      ...
      it('should returns ExceptionHandler object with exception filters',
         () => {
           const filter =
               exceptionFilter.create(new WithMetadata(), () => ({}) as any);
  ...
  describe('createConcreteContext', () => {
    ...
    beforeEach(() => {
      sinon.stub(exceptionFilter, 'findExceptionsFilterInstance')
          .onFirstCall()
          .returns({
            catch : () => ({}),
          })
