...
import {
  NestModule
} from '../../common/interfaces/modules/nest-module.interface';
...
describe('DependenciesScanner', () => {
  ...
  describe('reflectDynamicMetadata', () => {
    describe('when param has prototype', () => {
      it('should call "reflectGuards" and "reflectInterceptors"', () => {
        const reflectGuards =
            sinon.stub(scanner, 'reflectGuards').callsFake(() => undefined);
        const reflectInterceptors = sinon.stub(scanner, 'reflectInterceptors')
                                        .callsFake(() => undefined);
  ...
  describe('storeInjectable', () => {
    it('should call "addInjectable"', () => {
      const addInjectable =
          sinon.stub((scanner as any).container, 'addInjectable')
              .callsFake(() => undefined);
      const comp = {};
      const token = 'token';
  ...
  describe('reflectKeyMetadata', () => {
    ...
    it('should return array', () => {
      const result =
          scanner.reflectKeyMetadata(CompMethod, GUARDS_METADATA, 'method');
