...
} from '../errors/exceptions/unknown-export.exception';
...
export type CustomFactory =
    CustomComponent&{useFactory : (...args) => any, inject?: Metatype<any>[]};
export type CustomValue = CustomComponent&{useValue : any};
export type ComponentMetatype =
    Metatype<Injectable>|CustomFactory|CustomValue|CustomClass;
...
export class Module {
  ...
  get scope(): NestModuleMetatype[] { return this._scope; }

  get relatedModules(): Set<Module> { return this._relatedModules; }
  ...
  get exports(): Set<string> { return this._exports; }
  ...
  get metatype(): NestModuleMetatype { return this._metatype; }
  ...
  public isCustomProvider(component: ComponentMetatype):
      component is CustomClass|CustomFactory|CustomValue {
    return !isNil((component as CustomComponent).provide);
  }

  public addCustomProvider(component: CustomFactory|CustomValue|CustomClass,
  ...
  public addCustomExportedComponent(exportedComponent: CustomFactory|
                                    CustomValue|CustomClass) {
