...
export class MicroservicesModule {
  ...
  public static setupListeners(container,
  ...
  public static bindListeners(controllers:
                                  Map<string, InstanceWrapper<Controller>>,
                              server: Server&CustomTransportStrategy,
                              module: string) {
  ...
  public static bindClients(controllers:
                                Map<string, InstanceWrapper<Controller>>) {
