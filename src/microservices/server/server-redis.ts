...
export class ServerRedis extends Server implements CustomTransportStrategy {
  ...
  public createRedisClient() { return redis.createClient({url : this.url}); }
  ...
  public getAckQueueName(pattern) { return `${pattern}_ack`; }

  public getResQueueName(pattern) { return `${pattern}_res`; }
