...
} from '../../exceptions/invalid-module-config.exception';
import {
  ModuleMetadata
} from '../../interfaces/modules/module-metadata.interface';
 ...
 * - `components` - the list of components that belong to this module. They can
 * be injected between themselves.
 * - `exports` - the set of components, which should be available for modules,
