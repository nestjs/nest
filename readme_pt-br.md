...
## Descrição
Nest é uma estrutura para criar aplicações <a href="http://nodejs.org" target="_blank">Node.js</a> do lado do servidor, eficientes e escaláveis. Ele usa JavaScript moderno, é construído com <a href="http://www.typescriptlang.org" target="_blank">TypeScript</a> (preserva a compatibilidade com JavaScript puro) e combina elementos de POO (Programação Orientado a Objetos), FP (Programação Funcional) e FRP (Programação Reativa Funcional).

<p>No interior, o Nest faz uso do <a href="https://expressjs.com/" target="_blank">Express</a>, mas também fornece compatibilidade com uma ampla variedade de outras bibliotecas, como por exemplo <a href="https://github.com/fastify/fastify" target="_blank">Fastify</a>, permitindo o uso fácil de alta variedade de plugins de terceiros.</p>
...
* Para conferir o guia [guide](https://docs.nestjs.com), visite [docs.nestjs.com](https://docs.nestjs.com). :books:
* 要查看中文 [指南](readme_zh.md), 请访问 [docs.nestjs.cn](https://docs.nestjs.cn). :books:
* [가이드](readme_kr.md) 문서는 [docs.nestjs.com](https://docs.nestjs.com)에서 확인하실 수 있습니다. :books:
* [ガイド](readme_jp.md)は [docs.nestjs.com](https://docs.nestjs.com)でご確認ください。 :books:
* [Para ler em Português] (readme_pt-br.md) [docs.nestjs.com](https://docs.nestjs.com) :books:

## Perguntas

Para perguntas e suporte use o [canal do Discord](https://discord.gg/G7Qnnhy). A lista de problemas deste repositório é **exclusivamente** para relatórios de bugs e solicitações de recursos.
